...
class AuthManager:
    ...
    # TODO: Token id could be the "ISS" claim in token
    @callback
    ...
    def async_validate_access_token(self, token: str) -> models.RefreshToken | None:
        ...
        try:
            # TODO: Decodes the JWT header and payload without verifying the signature.
            unverif_claims = jwt_wrapper.unverified_hs256_token_decode(token)
        except jwt.InvalidTokenError:
            return None

        # TODO: Extract issuer from claim to look up refresh token for the user.
