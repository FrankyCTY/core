...
def websocket_command(
    ...
    def decorate(func: const.WebSocketCommandHandler) -> const.WebSocketCommandHandler:
        ...
        if is_dict and len(schema) == 1:  # type: ignore[arg-type]  # type only empty schema
            ...
            # TODO: _ws_schema and _ws_command could be used by async_register_command() to register the command into hass.data[websocket_api domain]. (see __init__.py in websocket_api)
