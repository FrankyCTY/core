...
class BlockedCalls:
    ...
    # TODO: The predefined function that we consider as blocking calls that we want to protect the event loop from.
    # TODO: Will be populated when enable() is called.
...
def enable() -> None:
    ...
    # TODO: Checks if blocking detection is already enabled (if yes, throws a RuntimeError).
    if calls:
